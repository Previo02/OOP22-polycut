...
class PhysicsImplTest {
    ...
    void doMathsTest() {
        ...
        final Sliceable test = new SliceableImpl(3, 1, new Point2D.Double(0, 0), new Point2D.Double(10, 10), 0);
        ...
        final Sliceable result = new SliceableImpl(3, 1, new Point2D.Double(1, 1), new Point2D.Double(10, 9.019), 0);
